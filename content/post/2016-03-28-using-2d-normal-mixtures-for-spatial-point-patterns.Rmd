---
title: Using 2D Normal Mixtures for Spatial Point Patterns
author: Yuchen Wang
date: '2016-03-28'
slug: using-2d-normal-mixtures-for-spatial-point-patterns
categories:
  - R
  - Statistics
tags:
...
Now we've introduced how to work with normal mixtures and intensity surfaces. In other posts, we'll introduce how to use data augmentation MCMC and birth-death MCMC to fit normal mixture to a given point pattern and some model diagnostics.

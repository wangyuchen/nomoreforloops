...
Updated 2019/03:
Just as I expected at the end of this post two years ago, a new package `vctrs` has come out to handle type stablity. You can watch [Hadley's talk](https://resources.rstudio.com/rstudio-conf-2019/vctrs-tools-for-making-size-and-type-consistent-functions) at the RStudio conference 2019, in which he talked about base `ifelse` being too free and `dplyr::if_else` being too strict.
